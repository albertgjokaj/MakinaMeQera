...
<body>
	...
	<section class="listings">
		<div class="wrapper">
		<h2 style="text-decoration:underline">Dergoji mesazh Adminit ketu</h2>
			<ul class="properties_list">
			<form method="post">
				<table>
					<tr>
						<td style="color: #003300; font-weight: bold; font-size: 24px">Shkruaj mesazhin ketu:</td>
					</tr>
					<tr>
						<td>&nbsp;</td>
					</tr>
					<tr>
						<td>
							<textarea name="message" placeholder="Shkruaj mesazhin ketu" class="txt"></textarea>
						</td>
					</tr>
					<tr>
					...
					if(isset($_POST['send'])){
						...
						$qry = "INSERT INTO message (message,client_id,time,status)
							...
							if($result == TRUE){
								...
								echo "<script type = \"text/javascript\">
											alert(\"Mesazhi nuk u dergua. Provo Perseri\");
