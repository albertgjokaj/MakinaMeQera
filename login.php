...
<body>
	...
	<section class="search">
		...
		<div id="fom">
			<form method="post">
			<h3 style="text-align:center; color: #000099; font-weight:bold; text-decoration:underline">Logimi i Adminit</h3>
				<table height="100" align="center">
					<tr>
						<td>Email:</td>
						<td><input type="text" name="uname" placeholder="Shkruaj Username" required></td>
					</tr>
					<tr>
						<td>Password:</td>
						<td><input type="password" name="pass" placeholder="Shkruaj Passwordin" required></td>
					</tr>
					<tr>
						<td colspan="2" style="text-align:center"><input type="submit" name="login" value="Logohu"></td>
					</tr>
				</table>
			</form>
			<?php
				if(isset($_POST['login'])){
					...
					if($num > 0){
						...
						echo "<script type = \"text/javascript\">
									alert(\"Logimi i susksesshem. Mire se erdhe ne Sistem\");
									window.location = (\"admin/index.php\")
									</script>";
					} else{
						echo "<script type = \"text/javascript\">
									alert(\"Logimi Deshtoi. Provo Perseri................\");
