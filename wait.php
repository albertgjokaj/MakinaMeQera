	...
	<section class="listings">
		<div class="wrapper">
			<ul class="properties_list">
				<h2 style="text-align:center; color:#FF0000; font-family: 'Courier New', Courier, monospace">Ju falenderojme per kerkesen tuaj. 
				Do ju kontaktojme menjehere pasi pagesa te konfirmohet.<br>
				Ti mund te logohesh qe te shikosh statusin e kerkeses tuaj duker perdorur emailin dhe Numrin ID nderkombetar si password.</h2>
			</ul>
