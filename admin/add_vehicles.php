...
<head>
	...
	<script type="text/javascript">
		function sureToApprove(id){
			if(confirm("Je i sigurt qe do te fshish kete makine?")){
		...
		<div id="main">
			...
			<div id="content">
				...
				<div class="box">
					<!-- Box Head -->
					<div class="box-head">
						<h2 class="left">Makinat Tona</h2>
						<div class="right">
							<label>kerko makine</label>
					...
					<div class="table">
						<table width="100%" border="0" cellspacing="0" cellpadding="0">
							...
							<tr>
								...
								<td><a href="javascript:sureToApprove(<?php echo $row['car_id'];?>)" class="ico del">Fshij</a></td>
							</tr>
							<?php
								}
							?>
						...
						<!-- Pagging -->
						<div class="pagging">
							<div class="left">Tregohen 1-12 nga 44</div>
							<div class="right">
								<a href="#">Para</a>
								<a href="#">1</a>
								<a href="#">2</a>
			...
			<div id="sidebar">
				...
				<div class="box">
					...
					<div class="box-content">
						<a href="add_cars.php" class="add-button"><span>Shto Makine te Re</span></a>
						<div class="cl">&nbsp;</div>
						
						
						<p><a href="#">Fshij te Selektuarat</a></p>
						
						<!-- Sort -->
						<div class="sort">
							<label>Rreshto nga</label>
							<select class="field">
								<option value="">Tipi</option>
								<option value="">Modeli Makines</option>
