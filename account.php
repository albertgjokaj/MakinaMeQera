...
<body>
	...
	<section class="search">
		...
		<div id="fom">
			<form method="post">
			<h3 style="text-align:center; color: #000099; font-weight:bold; text-decoration:underline">Logimi i Klientit</h3>
				<table height="100" align="center">
					<tr>
						<td>Adresa Email:</td>
						<td><input type="email" name="email" placeholder="Shkruaj adresen e  emailit" required></td>
					</tr>
					<tr>
						<td>Password:</td>
						<td><input type="password" name="pass" placeholder="Shkruaj paswordin" required></td>
					</tr>
					<tr>
						<td><input type="submit" name="log" value="Logohu"></td>
						<td style="text-align:right;"><a href="signup.php">Krijo account</a></td>
					</tr>
				</table>
			</form>
			<?php
